...
//    }
    ...
    public void testSlopeOrderComparator() {
        ...
        Assert.assertEquals(0, 
            originPoint.SLOPE_ORDER.compare(new Point(2, 2), p55));

        // First slope is smaller
        Assert.assertEquals(-1, 
            originPoint.SLOPE_ORDER.compare(new Point(5, 10), new Point(5, 25)));

        // Second slope is smaller
        Assert.assertEquals(+1, 
            originPoint.SLOPE_ORDER.compare(new Point(5, 25), new Point(5, 10)));
        
        Assert.assertEquals(0, 
            originPoint.SLOPE_ORDER.compare(new Point(1, 2), new Point(1, 3)));
    }
